    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const transactions = [
                ...
                db.tx.rotating_assigners[assignerId].link({ class: classId }),
            ];
            ...
            <CredenzaContent className="flex flex-col max-h-[90vh]">
                <form onSubmit={handleSubmit} className="flex flex-col h-full min-h-0 overflow-hidden">
                    <CredenzaHeader className="shrink-0">
                        <CredenzaTitle>Create Rotating Assigner</CredenzaTitle>
                        <CredenzaDescription>
                            Create a new rotating assigner with items that can be
                            assigned to students in a predictable sequence.
                        </CredenzaDescription>
                    </CredenzaHeader>
