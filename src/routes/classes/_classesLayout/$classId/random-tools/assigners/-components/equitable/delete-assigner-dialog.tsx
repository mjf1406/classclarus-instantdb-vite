...
interface DeleteAssignerDialogProps {
    assigner: InstaQLEntity<AppSchema, "equitable_assigners">;
...
export function DeleteAssignerDialog({
    ...
    const handleDelete = async () => {
        ...
        try {
            db.transact([db.tx.equitable_assigners[assigner.id].delete()]);
            setOpen(false);
            onDelete?.();
        } catch (err) {
    ...
    return (
        <AlertDialog open={open} onOpenChange={setOpen}>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>Delete Equitable Assigner</AlertDialogTitle>
                    <AlertDialogDescription>
